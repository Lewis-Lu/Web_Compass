<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Znz_Detection.aspx.cs" Inherits="nzn_web.Door_Service" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="margin-left:25%; margin-right:25%;">
            <h1 class="form-title col-md-12 font-family-inherit" style=" box-sizing: border-box; font-size: 1.667em; margin: 0px; font-family: 'Pingfang SC', 'Helvetica Neue', 'Microsoft Yahei', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft Sans Serif', 'WenQuanYi Micro Hei', sans; font-weight: bold; line-height: 1.1; color: rgb(34, 141, 210); min-height: 1px; padding: 25px 30px 10px; text-align: center; font-style: normal; font-variant: normal; letter-spacing: normal; orphans: auto; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgba(255, 255, 255, 0.843137);">2018年社会组织参与艾滋病防治基金项目——指南针工作室提供HIV、梅毒免费检测预约服务<br /></h1>
            <h1 class="form-title col-md-12 font-family-inherit" style=" box-sizing: border-box; font-size: 1.667em; margin: 0px; font-family: 'Pingfang SC', 'Helvetica Neue', 'Microsoft Yahei', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft Sans Serif', 'WenQuanYi Micro Hei', sans; font-weight: bold; line-height: 1.1; color: rgb(34, 141, 210); min-height: 1px; padding: 25px 30px 10px; text-align: center; font-style: normal; font-variant: normal; letter-spacing: normal; orphans: auto; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgba(255, 255, 255, 0.843137);">同伴快检<br /></h1>
            <p >
            ...
            <p >
                <strong>同行检测（最多选一项）：</strong></p>
            <p >
                <asp:RadioButtonList ID="RBL_checknumber" runat="server">
                    <asp:ListItem Value="一人">一人</asp:ListItem>
                    <asp:ListItem Value="二人">二人</asp:ListItem>
                </asp:RadioButtonList>
            </p>
            <p >
